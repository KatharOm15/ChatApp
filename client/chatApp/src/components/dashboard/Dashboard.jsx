...
function Dashboard() {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:3000/api/users?exclude=${userID}`)
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:3000/api/users/sent/${userID}`)
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:3000/api/friend-requests/pending/${userID}`)
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:3000/api/users/accepted/${userID}`)
  ...
  const handleSendRequest = (user) => {
    ...
    axios
      .post(`http://localhost:3000/api/friend-requests/send`, {
        from: userID,
        to: user._id,
      })
      .then(() => {
  ...
  const handleCancelRequest = (id) => {
    axios
      .delete(`http://localhost:3000/api/friend-requests/cancel`, {
  ...
  const handleAcceptRequest = (user) => {
    axios
      .post(`http://localhost:3000/api/friend-requests/accept`, {
        from: user._id,
        to: userID,
      })
      .then(() => {
  ...
  const handleRejectRequest = (user) => {
    axios
      .post(`http://localhost:3000/api/friend-requests/reject`, {
        from: user._id,
        to: userID,
      })
      .then(() => {
