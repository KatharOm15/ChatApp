...
function Dashboard() {
  ...
  useEffect(() => {
    axios
      .get(`https://chatapp-server-sxub.onrender.com/api/users?exclude=${userID}`)
  ...
  useEffect(() => {
    axios
      .get(`https://chatapp-server-sxub.onrender.com/api/users/sent/${userID}`)
  ...
  useEffect(() => {
    axios
      .get(`https://chatapp-server-sxub.onrender.com/api/friend-requests/pending/${userID}`)
  ...
  useEffect(() => {
    axios
      .get(`https://chatapp-server-sxub.onrender.com/api/users/accepted/${userID}`)
  ...
  const handleSendRequest = (user) => {
    ...
    axios
      .post(`https://chatapp-server-sxub.onrender.com/api/friend-requests/send`, {
        from: userID,
        to: user._id,
      })
      .then(() => {
  ...
  const handleCancelRequest = (id) => {
    axios
      .delete(`https://chatapp-server-sxub.onrender.com/api/friend-requests/cancel`, {
  ...
  const handleAcceptRequest = (user) => {
    axios
      .post(`https://chatapp-server-sxub.onrender.com/api/friend-requests/accept`, {
        from: user._id,
        to: userID,
      })
      .then(() => {
  ...
  const handleRejectRequest = (user) => {
    axios
      .post(`https://chatapp-server-sxub.onrender.com/api/friend-requests/reject`, {
        from: user._id,
        to: userID,
      })
      .then(() => {
